        ...
        <div className="max-w-screen max-h-screen flex justify-center items-center space-x-4">
          ...
          <div style={{ zIndex: 2 }}>
            <div className="flex flex-row">
              <h1
                className="font-serif leading-none tracking-tighter mb-4"
            ...
            <p className="font-serif text-4xl leading-none tracking-tighter mt-4">
              Unleashing Serenity, In the Heart of Kochi
            </p>
          </div>
          <Image
            src={home1}
